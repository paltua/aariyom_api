...
CREATE TABLE `functional_unit_images` (
  `fu_img_id` int(11) NOT NULL AUTO_INCREMENT,
  `fu_id` int(11) NOT NULL,
  `fu_img_name` varchar(100) NOT NULL,
  `created_by` int(11) DEFAULT NULL,
  `created_date` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_date` timestamp NULL DEFAULT NULL,
  `is_default` enum('1','0') DEFAULT '0',
  `is_completed` enum('1','0') DEFAULT '0',
  PRIMARY KEY (`fu_img_id`),
  KEY `index2` (`fu_id`,`is_completed`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1;