...
defined( 'IMAGE_PATH__EVENT' )      OR define( 'IMAGE_PATH__EVENT', 'images/events/' );
defined( 'IMAGE_PATH__FU' )      OR define( 'IMAGE_PATH__FU', 'images/fus/' );
defined( 'IMAGE_PATH__PROG' )      OR define( 'IMAGE_PATH__PROG', 'images/programs/' );